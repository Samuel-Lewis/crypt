...
static inline void AnimMoveX(sf::Transformable *s, float dist, int ticks, Animator &a, AnimationDelegate *delegate, std::string name)
{
...
static inline void AnimMoveY(sf::Transformable *s, float dist, int ticks, Animator &a, AnimationDelegate *delegate, std::string name)
{
